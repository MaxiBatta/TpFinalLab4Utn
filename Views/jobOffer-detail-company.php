...
$back = FRONT_ROOT . 'JobOffer/ShowJobOffersCatalogueCompanyView';
?>
<main class="py-5">
                        ...
                        <div class="card-body" style="">
                            ...
                            <?php if ($jobOfferByStudentList) {
                                ...
                                foreach ($jobOfferByStudentList as $jobOfferByStudent) { ?>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h5><?= $jobOfferByStudent->getFirstName() . " " . $jobOfferByStudent->getLastName()?></h5>
                                            <h6><a href="mailto:"><?= $jobOfferByStudent->getEmail() ?></a></h6>
                                            <h6><a href="tel:"><?= $jobOfferByStudent->getPhoneNumber() ?></a></h6>
                                        </div>
                                    </div>
                                    <hr>
                                <?php } 
