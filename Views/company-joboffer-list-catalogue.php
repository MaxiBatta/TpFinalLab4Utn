...
if (isset($_SESSION["found_jobOffers"])) {
    ...
    $removeSearch = '<a href="'. FRONT_ROOT.'Company/ShowJobOffersCatalogueView" class="btn btn-outline-danger text-strong" style="color: #ff0000">Restaurar</a>';
}
        ...
        <div class="container">
            ...
            if (!$jobOfferList) {
                ...
                $count = 0;
                    ...
                    if (!isset($_SESSION["companyLogged"])) {
